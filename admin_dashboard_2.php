            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="admin_dashboard.php" class="dropdown-item">Signup Details</a>
                        <a href="admin_dashboard_2.php" class="dropdown-item">Contact Details</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Admin Dashboard</h6>
                <h1 class="mb-5"></h1>
            </div>
            <div class="row g-4">
